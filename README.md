...
🔥This branch is for end-to-end training. To save the GPU RAM by preprocessing features berfor training, please switch to the [feat branch](https://github.com/sosppxo/3D-STMN/tree/feat) (only 7G of GPU RAM is needed for training).🔥
